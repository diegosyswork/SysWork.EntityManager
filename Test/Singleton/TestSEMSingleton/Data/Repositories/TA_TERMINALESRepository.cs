...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_TERMINALESRepository : BaseRepository<TA_TERMINALES>
	{
		public TA_TERMINALESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
