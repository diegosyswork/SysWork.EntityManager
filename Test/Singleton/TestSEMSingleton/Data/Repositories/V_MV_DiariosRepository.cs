...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MV_DiariosRepository : BaseRepository<V_MV_Diarios>
	{
		public V_MV_DiariosRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
