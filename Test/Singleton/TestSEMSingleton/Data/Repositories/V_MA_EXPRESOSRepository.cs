...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MA_EXPRESOSRepository : BaseRepository<V_MA_EXPRESOS>
	{
		public V_MA_EXPRESOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
