...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MV_CPTE_OBSERVRepository : BaseRepository<V_MV_CPTE_OBSERV>
	{
		public V_MV_CPTE_OBSERVRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
