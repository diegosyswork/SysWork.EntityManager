...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_CuentasComisionRepository : BaseRepository<V_TA_CuentasComision>
	{
		public V_TA_CuentasComisionRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
