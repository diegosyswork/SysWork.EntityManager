...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_COMPROBANTESRepository : BaseRepository<TA_COMPROBANTES>
	{
		public TA_COMPROBANTESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
