...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_RANGOS_DATOS_ADICRepository : BaseRepository<TA_RANGOS_DATOS_ADIC>
	{
		public TA_RANGOS_DATOS_ADICRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
