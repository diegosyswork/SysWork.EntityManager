...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_Cpra_VtaRepository : BaseRepository<V_TA_Cpra_Vta>
	{
		public V_TA_Cpra_VtaRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
