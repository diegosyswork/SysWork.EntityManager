...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MA_INSUMOSRepository : BaseRepository<V_MA_INSUMOS>
	{
		public V_MA_INSUMOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
