...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class L_MA_LicenciasCategoriasRepository : BaseRepository<L_MA_LicenciasCategorias>
	{
		public L_MA_LicenciasCategoriasRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
