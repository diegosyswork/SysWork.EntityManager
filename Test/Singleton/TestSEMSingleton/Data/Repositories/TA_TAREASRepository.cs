...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_TAREASRepository : BaseRepository<TA_TAREAS>
	{
		public TA_TAREASRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
