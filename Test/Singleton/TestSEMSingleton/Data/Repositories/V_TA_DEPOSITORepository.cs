...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_DEPOSITORepository : BaseRepository<V_TA_DEPOSITO>
	{
		public V_TA_DEPOSITORepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
