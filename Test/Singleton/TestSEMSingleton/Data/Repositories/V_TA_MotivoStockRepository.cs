...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_MotivoStockRepository : BaseRepository<V_TA_MotivoStock>
	{
		public V_TA_MotivoStockRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
