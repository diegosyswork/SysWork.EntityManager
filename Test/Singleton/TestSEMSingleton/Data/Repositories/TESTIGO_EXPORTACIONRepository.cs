...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TESTIGO_EXPORTACIONRepository : BaseRepository<TESTIGO_EXPORTACION>
	{
		public TESTIGO_EXPORTACIONRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
