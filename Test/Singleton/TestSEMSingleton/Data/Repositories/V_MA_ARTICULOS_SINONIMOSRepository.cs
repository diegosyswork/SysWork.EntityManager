...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MA_ARTICULOS_SINONIMOSRepository : BaseRepository<V_MA_ARTICULOS_SINONIMOS>
	{
		public V_MA_ARTICULOS_SINONIMOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
