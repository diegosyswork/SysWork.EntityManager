...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_MOTIVO_AJUSTESRepository : BaseRepository<V_TA_MOTIVO_AJUSTES>
	{
		public V_TA_MOTIVO_AJUSTESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
