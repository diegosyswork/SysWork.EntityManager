...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CASH_CTAS_PRINCIPALESRepository : BaseRepository<MA_CASH_CTAS_PRINCIPALES>
	{
		public MA_CASH_CTAS_PRINCIPALESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
