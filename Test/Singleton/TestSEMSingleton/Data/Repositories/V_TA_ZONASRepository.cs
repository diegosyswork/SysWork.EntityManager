...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_ZONASRepository : BaseRepository<V_TA_ZONAS>
	{
		public V_TA_ZONASRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
