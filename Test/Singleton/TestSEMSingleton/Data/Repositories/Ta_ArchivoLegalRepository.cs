...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class Ta_ArchivoLegalRepository : BaseRepository<Ta_ArchivoLegal>
	{
		public Ta_ArchivoLegalRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
