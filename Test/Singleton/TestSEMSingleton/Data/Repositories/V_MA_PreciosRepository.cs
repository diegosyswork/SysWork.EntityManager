...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MA_PreciosRepository : BaseRepository<V_MA_Precios>
	{
		public V_MA_PreciosRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
