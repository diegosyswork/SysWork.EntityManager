...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_COMBOSRepository : BaseRepository<V_TA_COMBOS>
	{
		public V_TA_COMBOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
