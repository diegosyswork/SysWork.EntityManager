...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MV_CpteTareasRepository : BaseRepository<V_MV_CpteTareas>
	{
		public V_MV_CpteTareasRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
