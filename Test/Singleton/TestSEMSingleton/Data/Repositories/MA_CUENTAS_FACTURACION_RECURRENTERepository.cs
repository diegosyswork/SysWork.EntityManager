...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CUENTAS_FACTURACION_RECURRENTERepository : BaseRepository<MA_CUENTAS_FACTURACION_RECURRENTE>
	{
		public MA_CUENTAS_FACTURACION_RECURRENTERepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
