...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_MA_LegajosRepository : BaseRepository<P_MA_Legajos>
	{
		public P_MA_LegajosRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
