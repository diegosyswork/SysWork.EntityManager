...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CASHPFE_GRUPORepository : BaseRepository<MA_CASHPFE_GRUPO>
	{
		public MA_CASHPFE_GRUPORepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
