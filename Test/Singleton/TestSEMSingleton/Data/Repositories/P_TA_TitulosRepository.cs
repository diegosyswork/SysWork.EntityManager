...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_TA_TitulosRepository : BaseRepository<P_TA_Titulos>
	{
		public P_TA_TitulosRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
		
		}

		public P_TA_Titulos GetByDescripcion (string Descripcion)
		{
