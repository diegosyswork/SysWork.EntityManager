...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class L_TA_CategoriasRepository : BaseRepository<L_TA_Categorias>
	{
		public L_TA_CategoriasRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
