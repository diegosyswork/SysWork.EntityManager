...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_TA_ParentescoRepository : BaseRepository<P_TA_Parentesco>
	{
		public P_TA_ParentescoRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
		
		}

		public P_TA_Parentesco GetByIdParentesco (string IdParentesco)
		{
			 return GetByLambdaExpressionFilter(entity =>  (entity.IdParentesco == IdParentesco));
		}
