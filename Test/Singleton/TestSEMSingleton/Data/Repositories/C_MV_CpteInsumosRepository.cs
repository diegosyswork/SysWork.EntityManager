...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class C_MV_CpteInsumosRepository : BaseRepository<C_MV_CpteInsumos>
	{
		public C_MV_CpteInsumosRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
