...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CUENTASADICRepository : BaseRepository<MA_CUENTASADIC>
	{
		public MA_CUENTASADICRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
