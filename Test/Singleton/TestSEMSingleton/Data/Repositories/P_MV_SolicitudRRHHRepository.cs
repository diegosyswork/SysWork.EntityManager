...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_MV_SolicitudRRHHRepository : BaseRepository<P_MV_SolicitudRRHH>
	{
		public P_MV_SolicitudRRHHRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
