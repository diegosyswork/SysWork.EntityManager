...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MA_POSICRepository : BaseRepository<V_MA_POSIC>
	{
		public V_MA_POSICRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
