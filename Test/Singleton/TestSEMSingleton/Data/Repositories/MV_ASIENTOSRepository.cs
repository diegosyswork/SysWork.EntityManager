...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MV_ASIENTOSRepository : BaseRepository<MV_ASIENTOS>
	{
		public MV_ASIENTOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
