...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_INTERFACES_DETALLERepository : BaseRepository<TA_INTERFACES_DETALLE>
	{
		public TA_INTERFACES_DETALLERepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
