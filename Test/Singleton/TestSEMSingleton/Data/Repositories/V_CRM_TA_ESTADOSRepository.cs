...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_CRM_TA_ESTADOSRepository : BaseRepository<V_CRM_TA_ESTADOS>
	{
		public V_CRM_TA_ESTADOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
