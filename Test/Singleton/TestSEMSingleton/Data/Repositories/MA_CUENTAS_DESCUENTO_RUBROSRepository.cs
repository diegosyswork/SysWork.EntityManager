...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CUENTAS_DESCUENTO_RUBROSRepository : BaseRepository<MA_CUENTAS_DESCUENTO_RUBROS>
	{
		public MA_CUENTAS_DESCUENTO_RUBROSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
