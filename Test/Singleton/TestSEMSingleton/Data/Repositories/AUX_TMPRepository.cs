...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class AUX_TMPRepository : BaseRepository<AUX_TMP>
	{
		public AUX_TMPRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
