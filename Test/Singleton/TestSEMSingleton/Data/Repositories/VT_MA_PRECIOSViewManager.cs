...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class VT_MA_PRECIOSViewManager : BaseViewManager<VT_MA_PRECIOS>
	{
		public VT_MA_PRECIOSViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
