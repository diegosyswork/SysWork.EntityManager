...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class L_TA_PartidosRepository : BaseRepository<L_TA_Partidos>
	{
		public L_TA_PartidosRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
