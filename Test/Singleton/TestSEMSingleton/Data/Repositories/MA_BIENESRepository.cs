...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_BIENESRepository : BaseRepository<MA_BIENES>
	{
		public MA_BIENESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
