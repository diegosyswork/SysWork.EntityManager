...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_FIDELIZACION_MV_PUNTOSRepository : BaseRepository<V_FIDELIZACION_MV_PUNTOS>
	{
		public V_FIDELIZACION_MV_PUNTOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
