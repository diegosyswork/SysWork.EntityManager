...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class C_RemitosFacturadosViewManager : BaseViewManager<C_RemitosFacturados>
	{
		public C_RemitosFacturadosViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
