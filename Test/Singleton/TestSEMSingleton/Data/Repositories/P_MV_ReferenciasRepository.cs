...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_MV_ReferenciasRepository : BaseRepository<P_MV_Referencias>
	{
		public P_MV_ReferenciasRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
