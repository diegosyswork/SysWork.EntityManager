...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class L_MA_LicenciasRepository : BaseRepository<L_MA_Licencias>
	{
		public L_MA_LicenciasRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
