...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_MV_DeudoresRepository : BaseRepository<P_MV_Deudores>
	{
		public P_MV_DeudoresRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
