...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MV_BIENES_DETALLERepository : BaseRepository<MV_BIENES_DETALLE>
	{
		public MV_BIENES_DETALLERepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
