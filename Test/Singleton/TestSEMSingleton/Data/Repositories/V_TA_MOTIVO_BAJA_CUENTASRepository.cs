...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_MOTIVO_BAJA_CUENTASRepository : BaseRepository<V_TA_MOTIVO_BAJA_CUENTAS>
	{
		public V_TA_MOTIVO_BAJA_CUENTASRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
