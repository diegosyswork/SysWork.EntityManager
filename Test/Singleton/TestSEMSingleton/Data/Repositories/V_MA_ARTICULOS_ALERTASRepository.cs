...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MA_ARTICULOS_ALERTASRepository : BaseRepository<V_MA_ARTICULOS_ALERTAS>
	{
		public V_MA_ARTICULOS_ALERTASRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
