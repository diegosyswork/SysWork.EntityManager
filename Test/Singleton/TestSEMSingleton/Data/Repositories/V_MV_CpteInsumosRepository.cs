...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MV_CpteInsumosRepository : BaseRepository<V_MV_CpteInsumos>
	{
		public V_MV_CpteInsumosRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
