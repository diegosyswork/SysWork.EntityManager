...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class STK_STOCK_EQUIVViewManager : BaseViewManager<STK_STOCK_EQUIV>
	{
		public STK_STOCK_EQUIVViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
