...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class T_VEHICULOS_NOVEDADESRepository : BaseRepository<T_VEHICULOS_NOVEDADES>
	{
		public T_VEHICULOS_NOVEDADESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
