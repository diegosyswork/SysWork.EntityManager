...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class C_RemitosPendientesSinProveedorViewManager : BaseViewManager<C_RemitosPendientesSinProveedor>
	{
		public C_RemitosPendientesSinProveedorViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
