...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_VISTASRepository : BaseRepository<TA_VISTAS>
	{
		public TA_VISTASRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
