...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MA_AERONAVES_DOCUMENTOSRepository : BaseRepository<V_MA_AERONAVES_DOCUMENTOS>
	{
		public V_MA_AERONAVES_DOCUMENTOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
