...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class C_MV_CpteTareasRepository : BaseRepository<C_MV_CpteTareas>
	{
		public C_MV_CpteTareasRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
