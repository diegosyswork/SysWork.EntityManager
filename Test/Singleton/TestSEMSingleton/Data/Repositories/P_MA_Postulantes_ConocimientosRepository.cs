...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_MA_Postulantes_ConocimientosRepository : BaseRepository<P_MA_Postulantes_Conocimientos>
	{
		public P_MA_Postulantes_ConocimientosRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
