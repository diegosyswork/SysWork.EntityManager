...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_MV_SolicitudRRHH_TitulosRepository : BaseRepository<P_MV_SolicitudRRHH_Titulos>
	{
		public P_MV_SolicitudRRHH_TitulosRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
