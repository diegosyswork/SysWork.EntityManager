...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CUENTAS_USUARIOSRepository : BaseRepository<MA_CUENTAS_USUARIOS>
	{
		public MA_CUENTAS_USUARIOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
