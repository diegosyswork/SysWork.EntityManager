...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_AGRUPCUENTAS_DETALLERepository : BaseRepository<TA_AGRUPCUENTAS_DETALLE>
	{
		public TA_AGRUPCUENTAS_DETALLERepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
