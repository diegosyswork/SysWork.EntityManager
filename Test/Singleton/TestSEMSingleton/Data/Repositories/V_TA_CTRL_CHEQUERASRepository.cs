...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_CTRL_CHEQUERASRepository : BaseRepository<V_TA_CTRL_CHEQUERAS>
	{
		public V_TA_CTRL_CHEQUERASRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
