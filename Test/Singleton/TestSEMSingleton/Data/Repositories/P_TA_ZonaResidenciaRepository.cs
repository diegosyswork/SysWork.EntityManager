...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_TA_ZonaResidenciaRepository : BaseRepository<P_TA_ZonaResidencia>
	{
		public P_TA_ZonaResidenciaRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
		
		}

		public P_TA_ZonaResidencia GetByDescripcion (string Descripcion)
		{
