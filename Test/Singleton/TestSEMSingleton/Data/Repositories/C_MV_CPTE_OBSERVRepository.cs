...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class C_MV_CPTE_OBSERVRepository : BaseRepository<C_MV_CPTE_OBSERV>
	{
		public C_MV_CPTE_OBSERVRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
