...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_PROCESOS_PRODUCTIVOSRepository : BaseRepository<V_TA_PROCESOS_PRODUCTIVOS>
	{
		public V_TA_PROCESOS_PRODUCTIVOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
