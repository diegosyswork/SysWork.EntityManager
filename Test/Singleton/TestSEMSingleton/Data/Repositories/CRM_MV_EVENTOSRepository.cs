...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class CRM_MV_EVENTOSRepository : BaseRepository<CRM_MV_EVENTOS>
	{
		public CRM_MV_EVENTOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
