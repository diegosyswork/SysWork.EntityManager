...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_BIENES_PROPIETARIOSRepository : BaseRepository<TA_BIENES_PROPIETARIOS>
	{
		public TA_BIENES_PROPIETARIOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
