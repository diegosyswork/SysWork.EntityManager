...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_CLASIFICACION_CREDITICIARepository : BaseRepository<V_TA_CLASIFICACION_CREDITICIA>
	{
		public V_TA_CLASIFICACION_CREDITICIARepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
