...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CASH_GRUPORepository : BaseRepository<MA_CASH_GRUPO>
	{
		public MA_CASH_GRUPORepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
