...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CONTACTOS_ADICRepository : BaseRepository<MA_CONTACTOS_ADIC>
	{
		public MA_CONTACTOS_ADICRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
