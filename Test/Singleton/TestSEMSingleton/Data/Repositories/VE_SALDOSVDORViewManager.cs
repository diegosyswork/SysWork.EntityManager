...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class VE_SALDOSVDORViewManager : BaseViewManager<VE_SALDOSVDOR>
	{
		public VE_SALDOSVDORViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
