...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_FAMILIASRepository : BaseRepository<V_TA_FAMILIAS>
	{
		public V_TA_FAMILIASRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
