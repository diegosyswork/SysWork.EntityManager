...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class GM_V_MV_PLANILLA_CABRepository : BaseRepository<GM_V_MV_PLANILLA_CAB>
	{
		public GM_V_MV_PLANILLA_CABRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
