...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_CATALOGOS_HTM_DETALLERepository : BaseRepository<V_TA_CATALOGOS_HTM_DETALLE>
	{
		public V_TA_CATALOGOS_HTM_DETALLERepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
