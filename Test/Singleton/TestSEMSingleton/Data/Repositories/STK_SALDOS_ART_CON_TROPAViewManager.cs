...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class STK_SALDOS_ART_CON_TROPAViewManager : BaseViewManager<STK_SALDOS_ART_CON_TROPA>
	{
		public STK_SALDOS_ART_CON_TROPAViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
