...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_vehiculosRepository : BaseRepository<MA_vehiculos>
	{
		public MA_vehiculosRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
