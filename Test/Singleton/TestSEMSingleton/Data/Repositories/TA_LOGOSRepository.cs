...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_LOGOSRepository : BaseRepository<TA_LOGOS>
	{
		public TA_LOGOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
