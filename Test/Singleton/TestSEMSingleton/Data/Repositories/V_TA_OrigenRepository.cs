...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_OrigenRepository : BaseRepository<V_TA_Origen>
	{
		public V_TA_OrigenRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
