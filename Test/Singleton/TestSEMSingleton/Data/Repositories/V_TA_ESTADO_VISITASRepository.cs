...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_ESTADO_VISITASRepository : BaseRepository<V_TA_ESTADO_VISITAS>
	{
		public V_TA_ESTADO_VISITASRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
