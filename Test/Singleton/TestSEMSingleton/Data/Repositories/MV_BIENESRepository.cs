...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MV_BIENESRepository : BaseRepository<MV_BIENES>
	{
		public MV_BIENESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
