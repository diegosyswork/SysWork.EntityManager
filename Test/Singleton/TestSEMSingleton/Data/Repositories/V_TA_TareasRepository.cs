...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_TareasRepository : BaseRepository<V_TA_Tareas>
	{
		public V_TA_TareasRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
