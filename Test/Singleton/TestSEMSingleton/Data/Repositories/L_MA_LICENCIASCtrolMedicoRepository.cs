...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class L_MA_LICENCIASCtrolMedicoRepository : BaseRepository<L_MA_LICENCIASCtrolMedico>
	{
		public L_MA_LICENCIASCtrolMedicoRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
