...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_UnidadRepository : BaseRepository<V_TA_Unidad>
	{
		public V_TA_UnidadRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
