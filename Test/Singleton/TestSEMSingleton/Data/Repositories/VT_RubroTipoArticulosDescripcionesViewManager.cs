...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class VT_RubroTipoArticulosDescripcionesViewManager : BaseViewManager<VT_RubroTipoArticulosDescripciones>
	{
		public VT_RubroTipoArticulosDescripcionesViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
