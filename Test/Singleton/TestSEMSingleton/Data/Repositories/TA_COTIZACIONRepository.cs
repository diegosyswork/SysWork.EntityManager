...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_COTIZACIONRepository : BaseRepository<TA_COTIZACION>
	{
		public TA_COTIZACIONRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
