...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CASHPFERepository : BaseRepository<MA_CASHPFE>
	{
		public MA_CASHPFERepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
