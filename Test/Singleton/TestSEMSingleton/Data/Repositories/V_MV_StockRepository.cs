...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	/// <summary>
	/// ********************************************************
	...
	public partial class V_MV_StockRepository : BaseRepository<V_MV_Stock>
	{
		public V_MV_StockRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
		
		}

		public V_MV_Stock GetByTCIDCOMPROBANTEIDCOMPLEMENTOSECUENCIACuentaProveedor (string TC,string IDCOMPROBANTE,long? IDCOMPLEMENTO,long? SECUENCIA,string CuentaProveedor)
		{
			 return GetByLambdaExpressionFilter(entity =>  (entity.TC == TC) && (entity.IDCOMPROBANTE == IDCOMPROBANTE) && (entity.IDCOMPLEMENTO == IDCOMPLEMENTO) && (entity.SECUENCIA == SECUENCIA) && (entity.CuentaProveedor == CuentaProveedor));
		}
