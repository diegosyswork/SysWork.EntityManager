...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MA_AERONAVES_COMPONENTESRepository : BaseRepository<V_MA_AERONAVES_COMPONENTES>
	{
		public V_MA_AERONAVES_COMPONENTESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
