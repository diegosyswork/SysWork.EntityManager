...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_BONIFICACIONES_COMPRASRepository : BaseRepository<V_TA_BONIFICACIONES_COMPRAS>
	{
		public V_TA_BONIFICACIONES_COMPRASRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
