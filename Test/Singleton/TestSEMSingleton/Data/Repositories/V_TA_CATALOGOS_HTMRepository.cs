...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_CATALOGOS_HTMRepository : BaseRepository<V_TA_CATALOGOS_HTM>
	{
		public V_TA_CATALOGOS_HTMRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
