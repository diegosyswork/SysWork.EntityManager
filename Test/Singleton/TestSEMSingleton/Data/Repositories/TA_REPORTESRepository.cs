...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_REPORTESRepository : BaseRepository<TA_REPORTES>
	{
		public TA_REPORTESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
