...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_MOTIVOS_ANULACIONESRepository : BaseRepository<V_TA_MOTIVOS_ANULACIONES>
	{
		public V_TA_MOTIVOS_ANULACIONESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
