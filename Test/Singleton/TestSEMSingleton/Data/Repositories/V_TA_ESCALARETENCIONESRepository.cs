...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_ESCALARETENCIONESRepository : BaseRepository<V_TA_ESCALARETENCIONES>
	{
		public V_TA_ESCALARETENCIONESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
