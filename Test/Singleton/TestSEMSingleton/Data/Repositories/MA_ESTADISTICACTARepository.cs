...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_ESTADISTICACTARepository : BaseRepository<MA_ESTADISTICACTA>
	{
		public MA_ESTADISTICACTARepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
