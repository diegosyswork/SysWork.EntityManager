...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CUENTAS_INFORMESRepository : BaseRepository<MA_CUENTAS_INFORMES>
	{
		public MA_CUENTAS_INFORMESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
