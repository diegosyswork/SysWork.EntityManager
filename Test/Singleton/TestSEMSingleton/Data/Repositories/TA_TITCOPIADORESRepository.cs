...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_TITCOPIADORESRepository : BaseRepository<TA_TITCOPIADORES>
	{
		public TA_TITCOPIADORESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
