...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class wsSysMobileVendedoresViewManager : BaseViewManager<wsSysMobileVendedores>
	{
		public wsSysMobileVendedoresViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
