...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_PUBLICACIONESRepository : BaseRepository<TA_PUBLICACIONES>
	{
		public TA_PUBLICACIONESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
