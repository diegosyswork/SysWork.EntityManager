...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class L_TA_LocalidadesRepository : BaseRepository<L_TA_Localidades>
	{
		public L_TA_LocalidadesRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
