...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MV_CpteTercerosRepository : BaseRepository<V_MV_CpteTerceros>
	{
		public V_MV_CpteTercerosRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
