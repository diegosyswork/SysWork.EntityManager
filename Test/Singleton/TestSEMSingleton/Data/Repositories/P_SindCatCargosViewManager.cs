...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class P_SindCatCargosViewManager : BaseViewManager<P_SindCatCargos>
	{
		public P_SindCatCargosViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
