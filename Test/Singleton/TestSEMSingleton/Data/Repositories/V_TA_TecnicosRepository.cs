...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_TecnicosRepository : BaseRepository<V_TA_Tecnicos>
	{
		public V_TA_TecnicosRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
