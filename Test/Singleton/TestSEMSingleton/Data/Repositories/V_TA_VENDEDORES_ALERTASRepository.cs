...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_VENDEDORES_ALERTASRepository : BaseRepository<V_TA_VENDEDORES_ALERTAS>
	{
		public V_TA_VENDEDORES_ALERTASRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
