...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MV_AgendaRepository : BaseRepository<MV_Agenda>
	{
		public MV_AgendaRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
