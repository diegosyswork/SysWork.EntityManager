...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_MV_SolicitudRRHH_ConocimientosRepository : BaseRepository<P_MV_SolicitudRRHH_Conocimientos>
	{
		public P_MV_SolicitudRRHH_ConocimientosRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
