...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_ALERTAS_STOCKRepository : BaseRepository<V_TA_ALERTAS_STOCK>
	{
		public V_TA_ALERTAS_STOCKRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
