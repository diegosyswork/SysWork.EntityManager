...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_REPORTES_PERSONALIZADOS_DETALLERepository : BaseRepository<V_TA_REPORTES_PERSONALIZADOS_DETALLE>
	{
		public V_TA_REPORTES_PERSONALIZADOS_DETALLERepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
