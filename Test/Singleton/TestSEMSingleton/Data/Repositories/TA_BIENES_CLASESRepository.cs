...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_BIENES_CLASESRepository : BaseRepository<TA_BIENES_CLASES>
	{
		public TA_BIENES_CLASESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
