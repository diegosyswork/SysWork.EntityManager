...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class VT_MV_APLICACIONViewManager : BaseViewManager<VT_MV_APLICACION>
	{
		public VT_MV_APLICACIONViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
