...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class C_MV_CPTE_PERCEPCIONESRepository : BaseRepository<C_MV_CPTE_PERCEPCIONES>
	{
		public C_MV_CPTE_PERCEPCIONESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
