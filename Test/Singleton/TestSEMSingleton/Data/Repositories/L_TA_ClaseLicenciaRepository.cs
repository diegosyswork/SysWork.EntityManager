...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class L_TA_ClaseLicenciaRepository : BaseRepository<L_TA_ClaseLicencia>
	{
		public L_TA_ClaseLicenciaRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
