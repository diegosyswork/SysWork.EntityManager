...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class L_TA_ExamenesRepository : BaseRepository<L_TA_Examenes>
	{
		public L_TA_ExamenesRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
