...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_MV_EntrevistasRepository : BaseRepository<P_MV_Entrevistas>
	{
		public P_MV_EntrevistasRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
