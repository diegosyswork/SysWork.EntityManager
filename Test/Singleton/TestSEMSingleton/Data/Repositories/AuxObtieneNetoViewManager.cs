...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class AuxObtieneNetoViewManager : BaseViewManager<AuxObtieneNeto>
	{
		public AuxObtieneNetoViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
