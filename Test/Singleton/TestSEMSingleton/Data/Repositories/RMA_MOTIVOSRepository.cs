...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class RMA_MOTIVOSRepository : BaseRepository<RMA_MOTIVOS>
	{
		public RMA_MOTIVOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
