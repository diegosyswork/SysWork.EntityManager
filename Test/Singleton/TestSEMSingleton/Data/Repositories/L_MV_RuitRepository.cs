...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class L_MV_RuitRepository : BaseRepository<L_MV_Ruit>
	{
		public L_MV_RuitRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
