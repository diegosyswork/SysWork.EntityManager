...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_MA_Postulantes_ObsRepository : BaseRepository<P_MA_Postulantes_Obs>
	{
		public P_MA_Postulantes_ObsRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
