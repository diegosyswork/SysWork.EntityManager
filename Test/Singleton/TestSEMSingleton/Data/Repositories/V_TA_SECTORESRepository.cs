...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_SECTORESRepository : BaseRepository<V_TA_SECTORES>
	{
		public V_TA_SECTORESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
