...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_DESTINORepository : BaseRepository<V_TA_DESTINO>
	{
		public V_TA_DESTINORepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
