...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_BIENES_MOTIVOSRepository : BaseRepository<TA_BIENES_MOTIVOS>
	{
		public TA_BIENES_MOTIVOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
