...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CUENTAS_ENCOMIENDASRepository : BaseRepository<MA_CUENTAS_ENCOMIENDAS>
	{
		public MA_CUENTAS_ENCOMIENDASRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
