...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class RMA_ESTADOSRepository : BaseRepository<RMA_ESTADOS>
	{
		public RMA_ESTADOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
