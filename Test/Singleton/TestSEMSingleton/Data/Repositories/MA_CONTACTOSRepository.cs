...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CONTACTOSRepository : BaseRepository<MA_CONTACTOS>
	{
		public MA_CONTACTOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
