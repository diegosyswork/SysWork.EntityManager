...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_BancosRepository : BaseRepository<V_TA_Bancos>
	{
		public V_TA_BancosRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
