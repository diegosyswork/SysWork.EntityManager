...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CASH_PROYECTADORepository : BaseRepository<MA_CASH_PROYECTADO>
	{
		public MA_CASH_PROYECTADORepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
