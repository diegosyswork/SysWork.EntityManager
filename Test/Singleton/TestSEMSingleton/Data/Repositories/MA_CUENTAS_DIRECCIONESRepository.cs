...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CUENTAS_DIRECCIONESRepository : BaseRepository<MA_CUENTAS_DIRECCIONES>
	{
		public MA_CUENTAS_DIRECCIONESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
