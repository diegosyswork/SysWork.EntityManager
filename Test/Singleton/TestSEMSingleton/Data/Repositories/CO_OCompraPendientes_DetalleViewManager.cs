...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class CO_OCompraPendientes_DetalleViewManager : BaseViewManager<CO_OCompraPendientes_Detalle>
	{
		public CO_OCompraPendientes_DetalleViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
