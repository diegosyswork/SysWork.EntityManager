...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MV_CpteDocRepository : BaseRepository<V_MV_CpteDoc>
	{
		public V_MV_CpteDocRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
