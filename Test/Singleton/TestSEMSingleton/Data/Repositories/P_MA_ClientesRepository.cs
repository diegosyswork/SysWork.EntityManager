...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_MA_ClientesRepository : BaseRepository<P_MA_Clientes>
	{
		public P_MA_ClientesRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
