...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_Interfaces_asignacionCamposRepository : BaseRepository<V_TA_Interfaces_asignacionCampos>
	{
		public V_TA_Interfaces_asignacionCamposRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
