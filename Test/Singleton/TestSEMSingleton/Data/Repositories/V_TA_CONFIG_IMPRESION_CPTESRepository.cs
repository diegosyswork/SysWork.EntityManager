...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_CONFIG_IMPRESION_CPTESRepository : BaseRepository<V_TA_CONFIG_IMPRESION_CPTES>
	{
		public V_TA_CONFIG_IMPRESION_CPTESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
