...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CUENTAS_ARCHIVOS_RELACIONADOSRepository : BaseRepository<MA_CUENTAS_ARCHIVOS_RELACIONADOS>
	{
		public MA_CUENTAS_ARCHIVOS_RELACIONADOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
