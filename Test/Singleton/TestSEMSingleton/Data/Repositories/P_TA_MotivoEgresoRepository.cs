...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_TA_MotivoEgresoRepository : BaseRepository<P_TA_MotivoEgreso>
	{
		public P_TA_MotivoEgresoRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
		
		}

		public P_TA_MotivoEgreso GetByIdMotivoEgreso (string IdMotivoEgreso)
		{
			 return GetByLambdaExpressionFilter(entity =>  (entity.IdMotivoEgreso == IdMotivoEgreso));
		}
