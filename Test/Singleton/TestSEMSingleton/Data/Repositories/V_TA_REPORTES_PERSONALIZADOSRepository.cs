...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_REPORTES_PERSONALIZADOSRepository : BaseRepository<V_TA_REPORTES_PERSONALIZADOS>
	{
		public V_TA_REPORTES_PERSONALIZADOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
