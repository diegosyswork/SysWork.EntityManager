...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CUENTASCCOSTORepository : BaseRepository<MA_CUENTASCCOSTO>
	{
		public MA_CUENTASCCOSTORepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
