...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_STATUS_OPRepository : BaseRepository<V_TA_STATUS_OP>
	{
		public V_TA_STATUS_OPRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
