...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MV_APLICACIONRepository : BaseRepository<MV_APLICACION>
	{
		public MV_APLICACIONRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
