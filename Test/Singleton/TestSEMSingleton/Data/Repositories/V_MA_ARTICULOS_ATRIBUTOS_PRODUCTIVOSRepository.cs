...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MA_ARTICULOS_ATRIBUTOS_PRODUCTIVOSRepository : BaseRepository<V_MA_ARTICULOS_ATRIBUTOS_PRODUCTIVOS>
	{
		public V_MA_ARTICULOS_ATRIBUTOS_PRODUCTIVOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
