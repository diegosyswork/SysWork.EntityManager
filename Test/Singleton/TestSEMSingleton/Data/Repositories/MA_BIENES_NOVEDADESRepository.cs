...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_BIENES_NOVEDADESRepository : BaseRepository<MA_BIENES_NOVEDADES>
	{
		public MA_BIENES_NOVEDADESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
