...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class VT_RankingConsumoViewManager : BaseViewManager<VT_RankingConsumo>
	{
		public VT_RankingConsumoViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
