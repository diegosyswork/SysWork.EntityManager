...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class P_TodasLasSolicitudesViewManager : BaseViewManager<P_TodasLasSolicitudes>
	{
		public P_TodasLasSolicitudesViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
