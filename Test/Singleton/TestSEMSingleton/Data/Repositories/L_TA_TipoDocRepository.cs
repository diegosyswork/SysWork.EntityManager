...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class L_TA_TipoDocRepository : BaseRepository<L_TA_TipoDoc>
	{
		public L_TA_TipoDocRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
