...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class RMA_TRAZABILIDAD_ARTICULOSRepository : BaseRepository<RMA_TRAZABILIDAD_ARTICULOS>
	{
		public RMA_TRAZABILIDAD_ARTICULOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
