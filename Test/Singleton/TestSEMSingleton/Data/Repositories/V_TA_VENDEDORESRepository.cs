...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_VENDEDORESRepository : BaseRepository<V_TA_VENDEDORES>
	{
		public V_TA_VENDEDORESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
