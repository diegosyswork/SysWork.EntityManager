...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class CO_FaltantesOCViewManager : BaseViewManager<CO_FaltantesOC>
	{
		public CO_FaltantesOCViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
