...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class dtpropertiesRepository : BaseRepository<dtproperties>
	{
		public dtpropertiesRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
