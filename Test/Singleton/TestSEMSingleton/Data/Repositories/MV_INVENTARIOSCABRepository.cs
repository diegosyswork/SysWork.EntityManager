...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MV_INVENTARIOSCABRepository : BaseRepository<MV_INVENTARIOSCAB>
	{
		public MV_INVENTARIOSCABRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
