...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class V_ConsultaDeRubroTipoProveerdorArticulosViewManager : BaseViewManager<V_ConsultaDeRubroTipoProveerdorArticulos>
	{
		public V_ConsultaDeRubroTipoProveerdorArticulosViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
