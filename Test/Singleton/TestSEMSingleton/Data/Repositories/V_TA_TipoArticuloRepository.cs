...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_TipoArticuloRepository : BaseRepository<V_TA_TipoArticulo>
	{
		public V_TA_TipoArticuloRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
