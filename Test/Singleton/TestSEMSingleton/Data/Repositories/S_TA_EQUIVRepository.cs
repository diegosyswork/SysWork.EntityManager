...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class S_TA_EQUIVRepository : BaseRepository<S_TA_EQUIV>
	{
		public S_TA_EQUIVRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
