...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class V_ImportesAplicadosViewManager : BaseViewManager<V_ImportesAplicados>
	{
		public V_ImportesAplicadosViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
