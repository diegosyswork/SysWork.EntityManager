...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CUENTAS_SUCURSALESRepository : BaseRepository<MA_CUENTAS_SUCURSALES>
	{
		public MA_CUENTAS_SUCURSALESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
