...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TMP_BusquedaPrecioRepository : BaseRepository<TMP_BusquedaPrecio>
	{
		public TMP_BusquedaPrecioRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
