...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_USUARIOSRepository : BaseRepository<TA_USUARIOS>
	{
		public TA_USUARIOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
