...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MV_CpteAccionesRepository : BaseRepository<V_MV_CpteAcciones>
	{
		public V_MV_CpteAccionesRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
