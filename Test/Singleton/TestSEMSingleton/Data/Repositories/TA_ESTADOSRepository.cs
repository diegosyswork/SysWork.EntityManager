...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_ESTADOSRepository : BaseRepository<TA_ESTADOS>
	{
		public TA_ESTADOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
