...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MV_CUOTASRepository : BaseRepository<V_MV_CUOTAS>
	{
		public V_MV_CUOTASRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
