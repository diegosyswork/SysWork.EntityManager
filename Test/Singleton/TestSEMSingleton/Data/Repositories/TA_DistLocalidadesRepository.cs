...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_DistLocalidadesRepository : BaseRepository<TA_DistLocalidades>
	{
		public TA_DistLocalidadesRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
