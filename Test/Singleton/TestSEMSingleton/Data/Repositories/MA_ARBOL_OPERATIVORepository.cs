...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_ARBOL_OPERATIVORepository : BaseRepository<MA_ARBOL_OPERATIVO>
	{
		public MA_ARBOL_OPERATIVORepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
