...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class SW_DOCUMENTADORViewManager : BaseViewManager<SW_DOCUMENTADOR>
	{
		public SW_DOCUMENTADORViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
