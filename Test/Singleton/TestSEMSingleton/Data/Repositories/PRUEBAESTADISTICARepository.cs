...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class PRUEBAESTADISTICARepository : BaseRepository<PRUEBAESTADISTICA>
	{
		public PRUEBAESTADISTICARepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
