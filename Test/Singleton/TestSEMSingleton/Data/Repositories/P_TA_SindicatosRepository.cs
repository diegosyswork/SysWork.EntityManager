...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_TA_SindicatosRepository : BaseRepository<P_TA_Sindicatos>
	{
		public P_TA_SindicatosRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
		
		}

		public P_TA_Sindicatos GetByIdSindicatoIdSind_CargoIdSind_Categoria (string IdSindicato,string IdSind_Cargo,string IdSind_Categoria)
		{
			 return GetByLambdaExpressionFilter(entity =>  (entity.IdSindicato == IdSindicato) && (entity.IdSind_Cargo == IdSind_Cargo) && (entity.IdSind_Categoria == IdSind_Categoria));
		}
