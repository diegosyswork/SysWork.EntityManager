...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CASHPFE_DETALLERepository : BaseRepository<MA_CASHPFE_DETALLE>
	{
		public MA_CASHPFE_DETALLERepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
