...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class EQ_COND_INTERFACESRepository : BaseRepository<EQ_COND_INTERFACES>
	{
		public EQ_COND_INTERFACESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
