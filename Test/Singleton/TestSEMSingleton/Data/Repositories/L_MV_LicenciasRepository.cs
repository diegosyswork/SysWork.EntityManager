...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class L_MV_LicenciasRepository : BaseRepository<L_MV_Licencias>
	{
		public L_MV_LicenciasRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
