...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_TA_CentroMedicoRepository : BaseRepository<P_TA_CentroMedico>
	{
		public P_TA_CentroMedicoRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
