...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_CONDIVARepository : BaseRepository<TA_CONDIVA>
	{
		public TA_CONDIVARepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
