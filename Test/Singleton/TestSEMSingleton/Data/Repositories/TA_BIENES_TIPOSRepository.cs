...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_BIENES_TIPOSRepository : BaseRepository<TA_BIENES_TIPOS>
	{
		public TA_BIENES_TIPOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
