...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_MotivoVtaRepository : BaseRepository<V_TA_MotivoVta>
	{
		public V_TA_MotivoVtaRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
