...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_MONEDASRepository : BaseRepository<TA_MONEDAS>
	{
		public TA_MONEDASRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
