...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_Input_ComprasRepository : BaseRepository<V_TA_Input_Compras>
	{
		public V_TA_Input_ComprasRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
