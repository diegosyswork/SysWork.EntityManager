...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class Aux_MV_CpteQRRepository : BaseRepository<Aux_MV_CpteQR>
	{
		public Aux_MV_CpteQRRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
