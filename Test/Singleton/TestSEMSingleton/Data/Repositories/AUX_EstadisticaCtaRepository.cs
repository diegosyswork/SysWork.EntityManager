...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class AUX_EstadisticaCtaRepository : BaseRepository<AUX_EstadisticaCta>
	{
		public AUX_EstadisticaCtaRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
