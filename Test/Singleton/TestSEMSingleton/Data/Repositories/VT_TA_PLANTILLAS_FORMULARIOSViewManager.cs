...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class VT_TA_PLANTILLAS_FORMULARIOSViewManager : BaseViewManager<VT_TA_PLANTILLAS_FORMULARIOS>
	{
		public VT_TA_PLANTILLAS_FORMULARIOSViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
