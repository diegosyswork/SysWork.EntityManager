...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class VT_MV_CUOTAS_PAGASViewManager : BaseViewManager<VT_MV_CUOTAS_PAGAS>
	{
		public VT_MV_CUOTAS_PAGASViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
