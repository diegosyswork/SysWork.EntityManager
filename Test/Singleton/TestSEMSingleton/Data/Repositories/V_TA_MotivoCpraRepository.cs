...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_MotivoCpraRepository : BaseRepository<V_TA_MotivoCpra>
	{
		public V_TA_MotivoCpraRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
