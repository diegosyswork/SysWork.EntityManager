...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class UTL_TA_VENTANASRepository : BaseRepository<UTL_TA_VENTANAS>
	{
		public UTL_TA_VENTANASRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
