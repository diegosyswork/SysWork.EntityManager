...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_CONFIGURACIONRepository : BaseRepository<TA_CONFIGURACION>
	{
		public TA_CONFIGURACIONRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
