...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_STATUS_NPRepository : BaseRepository<V_TA_STATUS_NP>
	{
		public V_TA_STATUS_NPRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
