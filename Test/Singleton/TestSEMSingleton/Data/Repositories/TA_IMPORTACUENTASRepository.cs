...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_IMPORTACUENTASRepository : BaseRepository<TA_IMPORTACUENTAS>
	{
		public TA_IMPORTACUENTASRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
