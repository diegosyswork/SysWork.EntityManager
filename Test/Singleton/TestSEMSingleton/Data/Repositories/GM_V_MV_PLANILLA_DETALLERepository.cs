...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class GM_V_MV_PLANILLA_DETALLERepository : BaseRepository<GM_V_MV_PLANILLA_DETALLE>
	{
		public GM_V_MV_PLANILLA_DETALLERepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
