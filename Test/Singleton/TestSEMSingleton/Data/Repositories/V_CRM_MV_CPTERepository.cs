...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_CRM_MV_CPTERepository : BaseRepository<V_CRM_MV_CPTE>
	{
		public V_CRM_MV_CPTERepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
