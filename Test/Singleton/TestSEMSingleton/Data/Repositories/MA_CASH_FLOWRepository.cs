...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CASH_FLOWRepository : BaseRepository<MA_CASH_FLOW>
	{
		public MA_CASH_FLOWRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
