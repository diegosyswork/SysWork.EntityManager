...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class P_SolucitudesAFinalizarViewManager : BaseViewManager<P_SolucitudesAFinalizar>
	{
		public P_SolucitudesAFinalizarViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
