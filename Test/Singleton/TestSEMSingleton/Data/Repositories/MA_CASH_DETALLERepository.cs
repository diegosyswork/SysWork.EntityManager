...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CASH_DETALLERepository : BaseRepository<MA_CASH_DETALLE>
	{
		public MA_CASH_DETALLERepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
