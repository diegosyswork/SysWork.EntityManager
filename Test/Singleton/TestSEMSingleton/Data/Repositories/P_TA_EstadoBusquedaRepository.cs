...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_TA_EstadoBusquedaRepository : BaseRepository<P_TA_EstadoBusqueda>
	{
		public P_TA_EstadoBusquedaRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
		
		}

		public P_TA_EstadoBusqueda GetByDescripcion (string Descripcion)
		{
