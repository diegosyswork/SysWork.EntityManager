...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class C_MV_CPTE_RANKING_CONSUMOViewManager : BaseViewManager<C_MV_CPTE_RANKING_CONSUMO>
	{
		public C_MV_CPTE_RANKING_CONSUMOViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
