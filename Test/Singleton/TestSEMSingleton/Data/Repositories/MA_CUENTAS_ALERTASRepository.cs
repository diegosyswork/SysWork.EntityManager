...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CUENTAS_ALERTASRepository : BaseRepository<MA_CUENTAS_ALERTAS>
	{
		public MA_CUENTAS_ALERTASRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
