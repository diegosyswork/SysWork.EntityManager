...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class AUX_BALANCEGRALRepository : BaseRepository<AUX_BALANCEGRAL>
	{
		public AUX_BALANCEGRALRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
