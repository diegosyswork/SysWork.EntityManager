...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_CategoriaRepository : BaseRepository<V_TA_Categoria>
	{
		public V_TA_CategoriaRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
