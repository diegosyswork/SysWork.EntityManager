...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_ATRIBUTOS_PROD_ARTICULOSRepository : BaseRepository<V_TA_ATRIBUTOS_PROD_ARTICULOS>
	{
		public V_TA_ATRIBUTOS_PROD_ARTICULOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
