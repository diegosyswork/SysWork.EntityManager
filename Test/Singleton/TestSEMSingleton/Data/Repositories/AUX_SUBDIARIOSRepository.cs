...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class AUX_SUBDIARIOSRepository : BaseRepository<AUX_SUBDIARIOS>
	{
		public AUX_SUBDIARIOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
