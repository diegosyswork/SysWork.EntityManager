...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class Aux_totalesRepository : BaseRepository<Aux_totales>
	{
		public Aux_totalesRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
