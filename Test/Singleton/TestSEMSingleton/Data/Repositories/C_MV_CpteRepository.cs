...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class C_MV_CpteRepository : BaseRepository<C_MV_Cpte>
	{
		public C_MV_CpteRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
