...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class LogDbRepository : BaseRepository<LogDb>
	{
		public LogDbRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
