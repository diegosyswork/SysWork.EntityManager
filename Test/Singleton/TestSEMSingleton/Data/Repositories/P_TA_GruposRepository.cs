...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_TA_GruposRepository : BaseRepository<P_TA_Grupos>
	{
		public P_TA_GruposRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
		
		}

		public P_TA_Grupos GetByIdGrupo (string IdGrupo)
		{
			 return GetByLambdaExpressionFilter(entity =>  (entity.IdGrupo == IdGrupo));
		}
