...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_MA_Postulantes_TitulosRepository : BaseRepository<P_MA_Postulantes_Titulos>
	{
		public P_MA_Postulantes_TitulosRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
