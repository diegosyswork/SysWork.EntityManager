...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class L_TA_DocumentacionRepository : BaseRepository<L_TA_Documentacion>
	{
		public L_TA_DocumentacionRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
