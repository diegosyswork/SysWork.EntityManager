...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_TA_IdiomasRepository : BaseRepository<P_TA_Idiomas>
	{
		public P_TA_IdiomasRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
		
		}

		public P_TA_Idiomas GetByDescripcion (string Descripcion)
		{
