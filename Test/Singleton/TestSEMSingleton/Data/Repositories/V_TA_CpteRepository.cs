...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_CpteRepository : BaseRepository<V_TA_Cpte>
	{
		public V_TA_CpteRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
