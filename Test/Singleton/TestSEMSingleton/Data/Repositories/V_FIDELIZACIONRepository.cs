...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_FIDELIZACIONRepository : BaseRepository<V_FIDELIZACION>
	{
		public V_FIDELIZACIONRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
