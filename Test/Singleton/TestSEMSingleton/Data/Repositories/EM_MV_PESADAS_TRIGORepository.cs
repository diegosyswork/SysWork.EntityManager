...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class EM_MV_PESADAS_TRIGORepository : BaseRepository<EM_MV_PESADAS_TRIGO>
	{
		public EM_MV_PESADAS_TRIGORepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
