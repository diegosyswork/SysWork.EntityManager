...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_TA_FuncionesRepository : BaseRepository<P_TA_Funciones>
	{
		public P_TA_FuncionesRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
		
		}

		public P_TA_Funciones GetByDescripcion (string Descripcion)
		{
