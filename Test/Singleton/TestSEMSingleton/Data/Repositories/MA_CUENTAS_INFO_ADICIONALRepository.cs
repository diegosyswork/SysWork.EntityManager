...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CUENTAS_INFO_ADICIONALRepository : BaseRepository<MA_CUENTAS_INFO_ADICIONAL>
	{
		public MA_CUENTAS_INFO_ADICIONALRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
