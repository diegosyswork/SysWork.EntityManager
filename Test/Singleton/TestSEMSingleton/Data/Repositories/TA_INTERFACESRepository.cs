...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_INTERFACESRepository : BaseRepository<TA_INTERFACES>
	{
		public TA_INTERFACESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
