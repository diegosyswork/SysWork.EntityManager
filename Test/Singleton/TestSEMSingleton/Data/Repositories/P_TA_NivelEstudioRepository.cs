...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_TA_NivelEstudioRepository : BaseRepository<P_TA_NivelEstudio>
	{
		public P_TA_NivelEstudioRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
		
		}

		public P_TA_NivelEstudio GetByDescripcion (string Descripcion)
		{
