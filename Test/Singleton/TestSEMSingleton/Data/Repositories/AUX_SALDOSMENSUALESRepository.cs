...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class AUX_SALDOSMENSUALESRepository : BaseRepository<AUX_SALDOSMENSUALES>
	{
		public AUX_SALDOSMENSUALESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
