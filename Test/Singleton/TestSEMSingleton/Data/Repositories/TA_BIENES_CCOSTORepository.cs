...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_BIENES_CCOSTORepository : BaseRepository<TA_BIENES_CCOSTO>
	{
		public TA_BIENES_CCOSTORepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
