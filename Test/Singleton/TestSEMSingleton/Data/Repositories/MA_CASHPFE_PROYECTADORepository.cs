...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CASHPFE_PROYECTADORepository : BaseRepository<MA_CASHPFE_PROYECTADO>
	{
		public MA_CASHPFE_PROYECTADORepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
