...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MA_ARTICULOS_PROCESOS_PRODUCTIVOSRepository : BaseRepository<V_MA_ARTICULOS_PROCESOS_PRODUCTIVOS>
	{
		public V_MA_ARTICULOS_PROCESOS_PRODUCTIVOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
