...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_ChoferesRepository : BaseRepository<MA_Choferes>
	{
		public MA_ChoferesRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
