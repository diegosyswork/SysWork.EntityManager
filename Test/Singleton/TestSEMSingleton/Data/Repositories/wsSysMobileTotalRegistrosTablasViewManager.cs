...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class wsSysMobileTotalRegistrosTablasViewManager : BaseViewManager<wsSysMobileTotalRegistrosTablas>
	{
		public wsSysMobileTotalRegistrosTablasViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
