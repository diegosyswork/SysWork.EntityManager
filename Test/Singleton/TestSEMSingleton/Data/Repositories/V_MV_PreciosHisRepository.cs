...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MV_PreciosHisRepository : BaseRepository<V_MV_PreciosHis>
	{
		public V_MV_PreciosHisRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
