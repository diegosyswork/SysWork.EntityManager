...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MV_CpteRepository : BaseRepository<V_MV_Cpte>
	{
		public V_MV_CpteRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
