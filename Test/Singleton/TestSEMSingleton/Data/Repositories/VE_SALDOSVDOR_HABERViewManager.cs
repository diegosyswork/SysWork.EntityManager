...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class VE_SALDOSVDOR_HABERViewManager : BaseViewManager<VE_SALDOSVDOR_HABER>
	{
		public VE_SALDOSVDOR_HABERViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
