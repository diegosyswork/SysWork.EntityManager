...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_MA_Postulantes_IdiomasRepository : BaseRepository<P_MA_Postulantes_Idiomas>
	{
		public P_MA_Postulantes_IdiomasRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
