...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class wsSysMobileRubrosViewManager : BaseViewManager<wsSysMobileRubros>
	{
		public wsSysMobileRubrosViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
