...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class C_Proveedores_CCompraRepository : BaseRepository<C_Proveedores_CCompra>
	{
		public C_Proveedores_CCompraRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
