...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class V_RemitosPendientesViewManager : BaseViewManager<V_RemitosPendientes>
	{
		public V_RemitosPendientesViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
