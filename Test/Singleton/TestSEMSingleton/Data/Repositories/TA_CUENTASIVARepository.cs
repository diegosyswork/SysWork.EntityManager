...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_CUENTASIVARepository : BaseRepository<TA_CUENTASIVA>
	{
		public TA_CUENTASIVARepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
