...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_TIPODOCUMENTORepository : BaseRepository<TA_TIPODOCUMENTO>
	{
		public TA_TIPODOCUMENTORepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
