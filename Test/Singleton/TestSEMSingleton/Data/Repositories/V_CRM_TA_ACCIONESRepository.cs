...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_CRM_TA_ACCIONESRepository : BaseRepository<V_CRM_TA_ACCIONES>
	{
		public V_CRM_TA_ACCIONESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
