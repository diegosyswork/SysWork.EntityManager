...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_CUENTAS_COMPROBANTESRepository : BaseRepository<TA_CUENTAS_COMPROBANTES>
	{
		public TA_CUENTAS_COMPROBANTESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
