...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MV_EJERCICIOSRepository : BaseRepository<MV_EJERCICIOS>
	{
		public MV_EJERCICIOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
