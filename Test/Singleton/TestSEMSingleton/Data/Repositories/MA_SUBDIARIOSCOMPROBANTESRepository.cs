...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_SUBDIARIOSCOMPROBANTESRepository : BaseRepository<MA_SUBDIARIOSCOMPROBANTES>
	{
		public MA_SUBDIARIOSCOMPROBANTESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
