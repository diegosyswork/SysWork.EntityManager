...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_DEPOSITO_MMRepository : BaseRepository<V_TA_DEPOSITO_MM>
	{
		public V_TA_DEPOSITO_MMRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
