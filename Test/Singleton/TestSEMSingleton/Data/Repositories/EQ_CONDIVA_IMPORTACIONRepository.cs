...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class EQ_CONDIVA_IMPORTACIONRepository : BaseRepository<EQ_CONDIVA_IMPORTACION>
	{
		public EQ_CONDIVA_IMPORTACIONRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
