...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CUENTAS_ENCOMIENDAS_CANTRepository : BaseRepository<MA_CUENTAS_ENCOMIENDAS_CANT>
	{
		public MA_CUENTAS_ENCOMIENDAS_CANTRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
