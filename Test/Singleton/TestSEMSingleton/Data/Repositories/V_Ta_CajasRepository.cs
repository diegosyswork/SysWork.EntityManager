...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_Ta_CajasRepository : BaseRepository<V_Ta_Cajas>
	{
		public V_Ta_CajasRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
