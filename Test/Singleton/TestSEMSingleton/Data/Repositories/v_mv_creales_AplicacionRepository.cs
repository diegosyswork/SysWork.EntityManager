...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class v_mv_creales_AplicacionRepository : BaseRepository<v_mv_creales_Aplicacion>
	{
		public v_mv_creales_AplicacionRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
