...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class EQ_TC_INTERFACERepository : BaseRepository<EQ_TC_INTERFACE>
	{
		public EQ_TC_INTERFACERepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
