...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class L_MA_LICENCIASEXAMENESRepository : BaseRepository<L_MA_LICENCIASEXAMENES>
	{
		public L_MA_LICENCIASEXAMENESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
