...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CUENTAS_FAMILIASRepository : BaseRepository<MA_CUENTAS_FAMILIAS>
	{
		public MA_CUENTAS_FAMILIASRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
