...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_PercepcionRepository : BaseRepository<V_TA_Percepcion>
	{
		public V_TA_PercepcionRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
