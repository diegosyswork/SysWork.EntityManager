...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_Input_VentasRepository : BaseRepository<V_TA_Input_Ventas>
	{
		public V_TA_Input_VentasRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
