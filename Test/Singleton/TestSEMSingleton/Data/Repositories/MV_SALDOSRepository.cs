...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MV_SALDOSRepository : BaseRepository<MV_SALDOS>
	{
		public MV_SALDOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
