...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_TA_CategorizacionRepository : BaseRepository<P_TA_Categorizacion>
	{
		public P_TA_CategorizacionRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
		
		}

		public P_TA_Categorizacion GetByDescripcion (string Descripcion)
		{
