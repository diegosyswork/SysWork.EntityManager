...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class LibroIvaVentasDirecto_ConsignadoViewManager : BaseViewManager<LibroIvaVentasDirecto_Consignado>
	{
		public LibroIvaVentasDirecto_ConsignadoViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
