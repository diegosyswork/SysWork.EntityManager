...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MA_AERONAVESRepository : BaseRepository<V_MA_AERONAVES>
	{
		public V_MA_AERONAVESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
