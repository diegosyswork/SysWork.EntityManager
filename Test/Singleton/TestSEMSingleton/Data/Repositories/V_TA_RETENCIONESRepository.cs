...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_RETENCIONESRepository : BaseRepository<V_TA_RETENCIONES>
	{
		public V_TA_RETENCIONESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
