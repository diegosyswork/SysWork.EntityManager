...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MV_CALCULO_BIENESRepository : BaseRepository<MV_CALCULO_BIENES>
	{
		public MV_CALCULO_BIENESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
