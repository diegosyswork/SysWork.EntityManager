...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_INDAJUSTERepository : BaseRepository<MA_INDAJUSTE>
	{
		public MA_INDAJUSTERepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
