...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_MV_SolicitudRRHH_IdiomasRepository : BaseRepository<P_MV_SolicitudRRHH_Idiomas>
	{
		public P_MV_SolicitudRRHH_IdiomasRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
