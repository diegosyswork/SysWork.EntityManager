...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_PLANTILLA_FORMULARIOSRepository : BaseRepository<V_TA_PLANTILLA_FORMULARIOS>
	{
		public V_TA_PLANTILLA_FORMULARIOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
