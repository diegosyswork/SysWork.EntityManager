...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_MARCASRepository : BaseRepository<TA_MARCAS>
	{
		public TA_MARCASRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
