...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_CCOSTORepository : BaseRepository<TA_CCOSTO>
	{
		public TA_CCOSTORepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
