...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class CRM_TA_EVENTOSRepository : BaseRepository<CRM_TA_EVENTOS>
	{
		public CRM_TA_EVENTOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
