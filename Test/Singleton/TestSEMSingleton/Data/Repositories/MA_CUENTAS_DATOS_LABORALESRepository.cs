...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CUENTAS_DATOS_LABORALESRepository : BaseRepository<MA_CUENTAS_DATOS_LABORALES>
	{
		public MA_CUENTAS_DATOS_LABORALESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
