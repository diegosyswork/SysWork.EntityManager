...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_Interfaces_EquivalenciaRepository : BaseRepository<V_TA_Interfaces_Equivalencia>
	{
		public V_TA_Interfaces_EquivalenciaRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
