...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class STK_SALDOS_SLViewManager : BaseViewManager<STK_SALDOS_SL>
	{
		public STK_SALDOS_SLViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
