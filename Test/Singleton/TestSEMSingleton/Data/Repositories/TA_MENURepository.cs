...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_MENURepository : BaseRepository<TA_MENU>
	{
		public TA_MENURepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
		
		}

		public TA_MENU GetByMenuClave (string Menu,string Clave)
		{
			 return GetByLambdaExpressionFilter(entity =>  (entity.Menu == Menu) && (entity.Clave == Clave));
		}
