...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_SUCURSALESRepository : BaseRepository<V_TA_SUCURSALES>
	{
		public V_TA_SUCURSALESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
