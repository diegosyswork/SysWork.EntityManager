...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_MV_SeguimientoRepository : BaseRepository<P_MV_Seguimiento>
	{
		public P_MV_SeguimientoRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
