...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CASH_CONTROLRepository : BaseRepository<MA_CASH_CONTROL>
	{
		public MA_CASH_CONTROLRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
