...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class VE_SALDOSCTA_DEBEViewManager : BaseViewManager<VE_SALDOSCTA_DEBE>
	{
		public VE_SALDOSCTA_DEBEViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
