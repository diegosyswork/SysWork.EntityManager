...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_MA_Postulantes_ExperienciaRepository : BaseRepository<P_MA_Postulantes_Experiencia>
	{
		public P_MA_Postulantes_ExperienciaRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
