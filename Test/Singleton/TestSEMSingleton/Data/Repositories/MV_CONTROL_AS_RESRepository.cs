...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MV_CONTROL_AS_RESRepository : BaseRepository<MV_CONTROL_AS_RES>
	{
		public MV_CONTROL_AS_RESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
