...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_TEMPORADASRepository : BaseRepository<V_TA_TEMPORADAS>
	{
		public V_TA_TEMPORADASRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
