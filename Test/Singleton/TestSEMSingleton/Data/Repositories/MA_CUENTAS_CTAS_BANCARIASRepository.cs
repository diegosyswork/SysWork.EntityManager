...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CUENTAS_CTAS_BANCARIASRepository : BaseRepository<MA_CUENTAS_CTAS_BANCARIAS>
	{
		public MA_CUENTAS_CTAS_BANCARIASRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
