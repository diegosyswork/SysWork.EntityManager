...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MV_SOLICITUD_ARTICULOSRepository : BaseRepository<V_MV_SOLICITUD_ARTICULOS>
	{
		public V_MV_SOLICITUD_ARTICULOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
