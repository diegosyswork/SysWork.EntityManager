...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_PAISESRepository : BaseRepository<TA_PAISES>
	{
		public TA_PAISESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
