...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_SUBDIARIOSRepository : BaseRepository<MA_SUBDIARIOS>
	{
		public MA_SUBDIARIOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
