...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CUENTAS_RUTEO_VENDEDORRepository : BaseRepository<MA_CUENTAS_RUTEO_VENDEDOR>
	{
		public MA_CUENTAS_RUTEO_VENDEDORRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
