...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_BIENES_ESTADOSRepository : BaseRepository<TA_BIENES_ESTADOS>
	{
		public TA_BIENES_ESTADOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
