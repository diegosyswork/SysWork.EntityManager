...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_MV_CtrolHorariosRepository : BaseRepository<P_MV_CtrolHorarios>
	{
		public P_MV_CtrolHorariosRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
