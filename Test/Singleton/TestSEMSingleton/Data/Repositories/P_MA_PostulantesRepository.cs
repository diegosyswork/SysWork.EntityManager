...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_MA_PostulantesRepository : BaseRepository<P_MA_Postulantes>
	{
		public P_MA_PostulantesRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
		
		}

		public P_MA_Postulantes GetByIdTipoDocumentoNroDocumento (string IdTipoDocumento,string NroDocumento)
		{
			 return GetByLambdaExpressionFilter(entity =>  (entity.IdTipoDocumento == IdTipoDocumento) && (entity.NroDocumento == NroDocumento));
		}
