...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class LibroIvaVentasViewManager : BaseViewManager<LibroIvaVentas>
	{
		public LibroIvaVentasViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
