...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_TA_EstadoPostulanteRepository : BaseRepository<P_TA_EstadoPostulante>
	{
		public P_TA_EstadoPostulanteRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
		
		}

		public P_TA_EstadoPostulante GetByDescripcion (string Descripcion)
		{
			 return GetByLambdaExpressionFilter(entity =>  (entity.Descripcion == Descripcion));
		}
