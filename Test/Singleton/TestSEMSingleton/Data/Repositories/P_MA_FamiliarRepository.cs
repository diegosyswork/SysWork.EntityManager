...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_MA_FamiliarRepository : BaseRepository<P_MA_Familiar>
	{
		public P_MA_FamiliarRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
