...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_AGRUPCUENTASRepository : BaseRepository<TA_AGRUPCUENTAS>
	{
		public TA_AGRUPCUENTASRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
