...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class tmp_cuotasViewManager : BaseViewManager<tmp_cuotas>
	{
		public tmp_cuotasViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
