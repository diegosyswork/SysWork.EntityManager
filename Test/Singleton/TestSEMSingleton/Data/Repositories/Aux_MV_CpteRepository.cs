...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class Aux_MV_CpteRepository : BaseRepository<Aux_MV_Cpte>
	{
		public Aux_MV_CpteRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
