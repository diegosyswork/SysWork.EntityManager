...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MV_INVENTARIOSRepository : BaseRepository<MV_INVENTARIOS>
	{
		public MV_INVENTARIOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
