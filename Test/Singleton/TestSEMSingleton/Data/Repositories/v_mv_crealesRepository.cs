...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class v_mv_crealesRepository : BaseRepository<v_mv_creales>
	{
		public v_mv_crealesRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
