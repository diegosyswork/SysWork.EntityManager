...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_CalendarioRepository : BaseRepository<MA_Calendario>
	{
		public MA_CalendarioRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
