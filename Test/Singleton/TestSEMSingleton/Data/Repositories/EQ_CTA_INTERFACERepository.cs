...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class EQ_CTA_INTERFACERepository : BaseRepository<EQ_CTA_INTERFACE>
	{
		public EQ_CTA_INTERFACERepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
