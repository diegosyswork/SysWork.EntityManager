...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class AUX_MAYORESRepository : BaseRepository<AUX_MAYORES>
	{
		public AUX_MAYORESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
