...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_IMPORTACUENTASDETALLERepository : BaseRepository<TA_IMPORTACUENTASDETALLE>
	{
		public TA_IMPORTACUENTASDETALLERepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
