...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_TA_FormasDePagoRepository : BaseRepository<P_TA_FormasDePago>
	{
		public P_TA_FormasDePagoRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
		
		}

		public P_TA_FormasDePago GetByDescripcion (string Descripcion)
		{
