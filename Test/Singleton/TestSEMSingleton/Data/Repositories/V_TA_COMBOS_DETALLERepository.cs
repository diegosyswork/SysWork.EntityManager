...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_COMBOS_DETALLERepository : BaseRepository<V_TA_COMBOS_DETALLE>
	{
		public V_TA_COMBOS_DETALLERepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
