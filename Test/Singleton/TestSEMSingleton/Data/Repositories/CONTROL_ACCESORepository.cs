...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class CONTROL_ACCESORepository : BaseRepository<CONTROL_ACCESO>
	{
		public CONTROL_ACCESORepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
