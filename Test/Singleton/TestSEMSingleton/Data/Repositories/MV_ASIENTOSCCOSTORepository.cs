...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MV_ASIENTOSCCOSTORepository : BaseRepository<MV_ASIENTOSCCOSTO>
	{
		public MV_ASIENTOSCCOSTORepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
