...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class L_TA_ControlMedicoRepository : BaseRepository<L_TA_ControlMedico>
	{
		public L_TA_ControlMedicoRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
