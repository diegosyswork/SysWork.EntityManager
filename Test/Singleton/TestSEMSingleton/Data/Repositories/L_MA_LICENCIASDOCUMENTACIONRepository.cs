...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class L_MA_LICENCIASDOCUMENTACIONRepository : BaseRepository<L_MA_LICENCIASDOCUMENTACION>
	{
		public L_MA_LICENCIASDOCUMENTACIONRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
