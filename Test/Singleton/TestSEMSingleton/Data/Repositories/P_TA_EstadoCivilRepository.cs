...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_TA_EstadoCivilRepository : BaseRepository<P_TA_EstadoCivil>
	{
		public P_TA_EstadoCivilRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
		
		}

		public P_TA_EstadoCivil GetByIdEstadoCivil (string IdEstadoCivil)
		{
			 return GetByLambdaExpressionFilter(entity =>  (entity.IdEstadoCivil == IdEstadoCivil));
		}
