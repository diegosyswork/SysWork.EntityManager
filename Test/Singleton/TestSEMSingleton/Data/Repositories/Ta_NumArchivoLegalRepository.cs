...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class Ta_NumArchivoLegalRepository : BaseRepository<Ta_NumArchivoLegal>
	{
		public Ta_NumArchivoLegalRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
