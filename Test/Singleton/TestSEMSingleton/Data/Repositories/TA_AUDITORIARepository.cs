...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_AUDITORIARepository : BaseRepository<TA_AUDITORIA>
	{
		public TA_AUDITORIARepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
