...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_TA_TipoPuestoRepository : BaseRepository<P_TA_TipoPuesto>
	{
		public P_TA_TipoPuestoRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
		
		}

		public P_TA_TipoPuesto GetByDescripcion (string Descripcion)
		{
