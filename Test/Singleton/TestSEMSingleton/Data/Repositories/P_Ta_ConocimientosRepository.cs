...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_Ta_ConocimientosRepository : BaseRepository<P_Ta_Conocimientos>
	{
		public P_Ta_ConocimientosRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
