...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_TA_ObraSocialRepository : BaseRepository<P_TA_ObraSocial>
	{
		public P_TA_ObraSocialRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
		
		}

		public P_TA_ObraSocial GetByIdObraSocial (string IdObraSocial)
		{
			 return GetByLambdaExpressionFilter(entity =>  (entity.IdObraSocial == IdObraSocial));
		}
