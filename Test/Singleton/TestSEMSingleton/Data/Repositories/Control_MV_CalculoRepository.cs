...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class Control_MV_CalculoRepository : BaseRepository<Control_MV_Calculo>
	{
		public Control_MV_CalculoRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
