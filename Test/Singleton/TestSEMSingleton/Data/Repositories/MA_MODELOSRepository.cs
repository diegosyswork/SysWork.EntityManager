...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class MA_MODELOSRepository : BaseRepository<MA_MODELOS>
	{
		public MA_MODELOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
