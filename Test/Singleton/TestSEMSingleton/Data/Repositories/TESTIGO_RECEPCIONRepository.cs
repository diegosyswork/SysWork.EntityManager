...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TESTIGO_RECEPCIONRepository : BaseRepository<TESTIGO_RECEPCION>
	{
		public TESTIGO_RECEPCIONRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
