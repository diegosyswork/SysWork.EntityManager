...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_MA_EmpresasRepository : BaseRepository<P_MA_Empresas>
	{
		public P_MA_EmpresasRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
