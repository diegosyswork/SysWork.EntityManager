...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_MV_CpteEnComisionRepository : BaseRepository<V_MV_CpteEnComision>
	{
		public V_MV_CpteEnComisionRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
