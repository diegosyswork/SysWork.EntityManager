...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_RubrosRepository : BaseRepository<V_TA_Rubros>
	{
		public V_TA_RubrosRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
