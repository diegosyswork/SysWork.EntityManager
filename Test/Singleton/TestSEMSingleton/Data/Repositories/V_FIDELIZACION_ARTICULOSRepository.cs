...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_FIDELIZACION_ARTICULOSRepository : BaseRepository<V_FIDELIZACION_ARTICULOS>
	{
		public V_FIDELIZACION_ARTICULOSRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
