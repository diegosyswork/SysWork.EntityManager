...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class P_SaldosClientesBusquedasViewManager : BaseViewManager<P_SaldosClientesBusquedas>
	{
		public P_SaldosClientesBusquedasViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
