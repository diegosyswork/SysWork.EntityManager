...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class AUX_MV_CPTE_COBRANZAS_COMPROBANTESViewManager : BaseViewManager<AUX_MV_CPTE_COBRANZAS_COMPROBANTES>
	{
		public AUX_MV_CPTE_COBRANZAS_COMPROBANTESViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
