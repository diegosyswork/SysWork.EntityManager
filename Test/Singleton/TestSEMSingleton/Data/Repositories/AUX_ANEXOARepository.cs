...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class AUX_ANEXOARepository : BaseRepository<AUX_ANEXOA>
	{
		public AUX_ANEXOARepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
