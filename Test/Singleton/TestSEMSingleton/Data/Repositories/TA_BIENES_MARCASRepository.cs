...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_BIENES_MARCASRepository : BaseRepository<TA_BIENES_MARCAS>
	{
		public TA_BIENES_MARCASRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
