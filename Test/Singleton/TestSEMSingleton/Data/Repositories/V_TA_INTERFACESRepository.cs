...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_INTERFACESRepository : BaseRepository<V_TA_INTERFACES>
	{
		public V_TA_INTERFACESRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
