...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class P_EntrevistasPendientesViewManager : BaseViewManager<P_EntrevistasPendientes>
	{
		public P_EntrevistasPendientesViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
