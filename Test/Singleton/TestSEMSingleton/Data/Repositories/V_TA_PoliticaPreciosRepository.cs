...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class V_TA_PoliticaPreciosRepository : BaseRepository<V_TA_PoliticaPrecios>
	{
		public V_TA_PoliticaPreciosRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
