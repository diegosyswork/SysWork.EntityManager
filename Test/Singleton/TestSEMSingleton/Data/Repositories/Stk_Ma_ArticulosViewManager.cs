...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class Stk_Ma_ArticulosViewManager : BaseViewManager<Stk_Ma_Articulos>
	{
		public Stk_Ma_ArticulosViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
