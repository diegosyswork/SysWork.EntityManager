...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class TA_TIPOVEHICULORepository : BaseRepository<TA_TIPOVEHICULO>
	{
		public TA_TIPOVEHICULORepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
