...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class AUX_EST_PRODRepository : BaseRepository<AUX_EST_PROD>
	{
		public AUX_EST_PRODRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
