...
namespace SysWork.SWCG.Test.Entities.ViewManagers
{
	...
	public partial class V_ChequesRecibidosViewManager : BaseViewManager<V_ChequesRecibidos>
	{
		public V_ChequesRecibidosViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
