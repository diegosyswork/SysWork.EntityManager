...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class AUX_TOTALES_DETRepository : BaseRepository<AUX_TOTALES_DET>
	{
		public AUX_TOTALES_DETRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
