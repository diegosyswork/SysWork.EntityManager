...
namespace SysWork.SWCG.Test.Entities.Repositories
{
	...
	public partial class P_TA_AreasRepository : BaseRepository<P_TA_Areas>
	{
		public P_TA_AreasRepository (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
		
		}

		public P_TA_Areas GetByDescripcion (string Descripcion)
		{
