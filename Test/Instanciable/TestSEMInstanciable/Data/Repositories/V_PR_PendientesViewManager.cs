...
namespace Test.ViewManagers
{
	...
	public partial class V_PR_PendientesViewManager : BaseViewManager<V_PR_Pendientes>
	{
		public V_PR_PendientesViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
