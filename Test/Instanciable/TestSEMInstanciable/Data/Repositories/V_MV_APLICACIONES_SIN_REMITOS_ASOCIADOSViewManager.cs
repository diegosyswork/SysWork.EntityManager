...
namespace Test.ViewManagers
{
	...
	public partial class V_MV_APLICACIONES_SIN_REMITOS_ASOCIADOSViewManager : BaseViewManager<V_MV_APLICACIONES_SIN_REMITOS_ASOCIADOS>
	{
		public V_MV_APLICACIONES_SIN_REMITOS_ASOCIADOSViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
