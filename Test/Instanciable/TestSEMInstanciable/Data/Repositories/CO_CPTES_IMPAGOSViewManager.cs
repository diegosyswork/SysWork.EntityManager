...
namespace Test.ViewManagers
{
	...
	public partial class CO_CPTES_IMPAGOSViewManager : BaseViewManager<CO_CPTES_IMPAGOS>
	{
		public CO_CPTES_IMPAGOSViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
