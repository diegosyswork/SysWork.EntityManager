...
namespace Test.ViewManagers
{
	...
	public partial class P_EvaluacionesViewManager : BaseViewManager<P_Evaluaciones>
	{
		public P_EvaluacionesViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
