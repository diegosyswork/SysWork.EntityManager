...
namespace Test.ViewManagers
{
	...
	public partial class V_ChequesFirmadosViewManager : BaseViewManager<V_ChequesFirmados>
	{
		public V_ChequesFirmadosViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
