...
namespace Test.ViewManagers
{
	...
	public partial class STK_PuntoReposicionViewManager : BaseViewManager<STK_PuntoReposicion>
	{
		public STK_PuntoReposicionViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
