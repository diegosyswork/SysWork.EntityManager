...
namespace Test.ViewManagers
{
	...
	public partial class VT_ULTIMOS_PRECIOS_COMPRAViewManager : BaseViewManager<VT_ULTIMOS_PRECIOS_COMPRA>
	{
		public VT_ULTIMOS_PRECIOS_COMPRAViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
