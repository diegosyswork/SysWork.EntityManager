...
namespace Test.ViewManagers
{
	...
	public partial class VT_V_MV_INSUMOS_APLICACIONViewManager : BaseViewManager<VT_V_MV_INSUMOS_APLICACION>
	{
		public VT_V_MV_INSUMOS_APLICACIONViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
