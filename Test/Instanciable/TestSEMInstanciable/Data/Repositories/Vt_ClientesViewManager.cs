...
namespace Test.ViewManagers
{
	...
	public partial class Vt_ClientesViewManager : BaseViewManager<Vt_Clientes>
	{
		public Vt_ClientesViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
