...
namespace Test.ViewManagers
{
	...
	public partial class AUX_MV_CPTE_COBRANZASViewManager : BaseViewManager<AUX_MV_CPTE_COBRANZAS>
	{
		public AUX_MV_CPTE_COBRANZASViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
