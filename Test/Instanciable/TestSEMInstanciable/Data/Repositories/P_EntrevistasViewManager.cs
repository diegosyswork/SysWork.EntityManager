...
namespace Test.ViewManagers
{
	...
	public partial class P_EntrevistasViewManager : BaseViewManager<P_Entrevistas>
	{
		public P_EntrevistasViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
