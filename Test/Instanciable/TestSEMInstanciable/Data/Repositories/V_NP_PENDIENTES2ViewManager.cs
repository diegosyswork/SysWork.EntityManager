...
namespace Test.ViewManagers
{
	...
	public partial class V_NP_PENDIENTES2ViewManager : BaseViewManager<V_NP_PENDIENTES2>
	{
		public V_NP_PENDIENTES2ViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
