...
namespace Test.ViewManagers
{
	...
	public partial class P_AUX_LEGAJOSViewManager : BaseViewManager<P_AUX_LEGAJOS>
	{
		public P_AUX_LEGAJOSViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
