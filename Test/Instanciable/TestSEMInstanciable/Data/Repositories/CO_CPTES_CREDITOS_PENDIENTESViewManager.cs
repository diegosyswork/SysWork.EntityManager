...
namespace Test.ViewManagers
{
	...
	public partial class CO_CPTES_CREDITOS_PENDIENTESViewManager : BaseViewManager<CO_CPTES_CREDITOS_PENDIENTES>
	{
		public CO_CPTES_CREDITOS_PENDIENTESViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
