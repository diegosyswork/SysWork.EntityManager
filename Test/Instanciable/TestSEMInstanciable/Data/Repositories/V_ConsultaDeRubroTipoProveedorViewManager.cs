...
namespace Test.ViewManagers
{
	...
	public partial class V_ConsultaDeRubroTipoProveedorViewManager : BaseViewManager<V_ConsultaDeRubroTipoProveedor>
	{
		public V_ConsultaDeRubroTipoProveedorViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
