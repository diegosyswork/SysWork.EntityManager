...
namespace Test.ViewManagers
{
	...
	public partial class C_RemitosSinAplicacionViewManager : BaseViewManager<C_RemitosSinAplicacion>
	{
		public C_RemitosSinAplicacionViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
