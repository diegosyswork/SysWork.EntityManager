...
namespace Test.ViewManagers
{
	...
	public partial class NW_DOCUMENTADORViewManager : BaseViewManager<NW_DOCUMENTADOR>
	{
		public NW_DOCUMENTADORViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
