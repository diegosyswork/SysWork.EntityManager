...
namespace Test.ViewManagers
{
	...
	public partial class VT_PLANILLASMovilesViewManager : BaseViewManager<VT_PLANILLASMoviles>
	{
		public VT_PLANILLASMovilesViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
