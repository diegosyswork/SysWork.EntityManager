...
namespace Test.ViewManagers
{
	...
	public partial class ChequesFirmadosNoConciliadosViewManager : BaseViewManager<ChequesFirmadosNoConciliados>
	{
		public ChequesFirmadosNoConciliadosViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
