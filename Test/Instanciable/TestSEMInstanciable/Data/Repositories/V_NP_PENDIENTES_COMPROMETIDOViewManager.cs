...
namespace Test.ViewManagers
{
	...
	public partial class V_NP_PENDIENTES_COMPROMETIDOViewManager : BaseViewManager<V_NP_PENDIENTES_COMPROMETIDO>
	{
		public V_NP_PENDIENTES_COMPROMETIDOViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
