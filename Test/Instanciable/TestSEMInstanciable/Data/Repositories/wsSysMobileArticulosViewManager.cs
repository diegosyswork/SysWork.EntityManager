...
namespace Test.ViewManagers
{
	...
	public partial class wsSysMobileArticulosViewManager : BaseViewManager<wsSysMobileArticulos>
	{
		public wsSysMobileArticulosViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
