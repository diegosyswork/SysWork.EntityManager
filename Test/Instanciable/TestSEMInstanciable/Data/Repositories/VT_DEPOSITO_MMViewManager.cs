...
namespace Test.ViewManagers
{
	...
	public partial class VT_DEPOSITO_MMViewManager : BaseViewManager<VT_DEPOSITO_MM>
	{
		public VT_DEPOSITO_MMViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
