...
namespace Test.ViewManagers
{
	...
	public partial class VE_CPTES_IMPAGOSViewManager : BaseViewManager<VE_CPTES_IMPAGOS>
	{
		public VE_CPTES_IMPAGOSViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
