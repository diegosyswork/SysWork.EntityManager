...
namespace Test.ViewManagers
{
	...
	public partial class V_ChequesEnCarteraViewManager : BaseViewManager<V_ChequesEnCartera>
	{
		public V_ChequesEnCarteraViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
