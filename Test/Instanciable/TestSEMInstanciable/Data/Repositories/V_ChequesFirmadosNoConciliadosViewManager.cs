...
namespace Test.ViewManagers
{
	...
	public partial class V_ChequesFirmadosNoConciliadosViewManager : BaseViewManager<V_ChequesFirmadosNoConciliados>
	{
		public V_ChequesFirmadosNoConciliadosViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
