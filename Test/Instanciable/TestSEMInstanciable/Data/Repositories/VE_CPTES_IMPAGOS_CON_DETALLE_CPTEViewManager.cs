...
namespace Test.ViewManagers
{
	...
	public partial class VE_CPTES_IMPAGOS_CON_DETALLE_CPTEViewManager : BaseViewManager<VE_CPTES_IMPAGOS_CON_DETALLE_CPTE>
	{
		public VE_CPTES_IMPAGOS_CON_DETALLE_CPTEViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
