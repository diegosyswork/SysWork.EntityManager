...
namespace Test.ViewManagers
{
	...
	public partial class P_SolucitudesPostulantesViewManager : BaseViewManager<P_SolucitudesPostulantes>
	{
		public P_SolucitudesPostulantesViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
