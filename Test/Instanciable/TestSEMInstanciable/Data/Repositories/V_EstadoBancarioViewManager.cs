...
namespace Test.ViewManagers
{
	...
	public partial class V_EstadoBancarioViewManager : BaseViewManager<V_EstadoBancario>
	{
		public V_EstadoBancarioViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
