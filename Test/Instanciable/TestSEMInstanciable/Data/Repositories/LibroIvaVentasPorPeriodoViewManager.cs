...
namespace Test.ViewManagers
{
	...
	public partial class LibroIvaVentasPorPeriodoViewManager : BaseViewManager<LibroIvaVentasPorPeriodo>
	{
		public LibroIvaVentasPorPeriodoViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
