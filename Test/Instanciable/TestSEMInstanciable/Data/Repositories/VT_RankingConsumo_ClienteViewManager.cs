...
namespace Test.ViewManagers
{
	...
	public partial class VT_RankingConsumo_ClienteViewManager : BaseViewManager<VT_RankingConsumo_Cliente>
	{
		public VT_RankingConsumo_ClienteViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
