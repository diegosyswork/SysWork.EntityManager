...
namespace Test.ViewManagers
{
	...
	public partial class VE_CPTES_CREDITOS_PENDIENTESViewManager : BaseViewManager<VE_CPTES_CREDITOS_PENDIENTES>
	{
		public VE_CPTES_CREDITOS_PENDIENTESViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
