...
namespace Test.ViewManagers
{
	...
	public partial class VT_COBRANZASViewManager : BaseViewManager<VT_COBRANZAS>
	{
		public VT_COBRANZASViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
