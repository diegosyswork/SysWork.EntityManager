...
{
	[Table (Name = "MV_ASIENTOS")]
	public partial class MV_ASIENTOS
	{
		/// <summary>
		...
		[Column()]
		public double? TJ_Presentacion { get; set; }
		[Column()]
		public double? TJ_Liquidacion { get; set; }
		[Column()]
		public string Tc_Origen { get; set; }
		[Column()]
		public string Cpte_Origen { get; set; }
		[Column()]
		public long? Complemento_Origen { get; set; }
		[Column()]
		...
		[Column()]
		public string PAGUESE_A { get; set; }
		[Column()]
		...
		[Column()]
		public string CERT_RETENCION_SUSS { get; set; }
		[Column()]
		public string CERT_RETENCION_OTROS { get; set; }
		[Column()]
		public string nroCuitFirmante { get; set; }
		[Column()]
		...
		[Column()]
		public decimal? LIVA_PERC_OTROS { get; set; }
	}
}
