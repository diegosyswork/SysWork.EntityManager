...
{
	[Table (Name = "V_TA_Cpte")]
	public partial class V_TA_Cpte
	{
		/// <summary>
		...
		[Column()]
		public bool TALONARIO_ELECTRONICO { get; set; }
		[Column()]
		...
		[Column()]
		public long? COLOR_M { get; set; }
		[Column()]
		public DateTime? M_VENCIMIENTO { get; set; }
		[Column()]
		public string M_OBSERVACIONES { get; set; }
		[Column()]
		public bool TALONARIO_MiPyMEsFCE { get; set; }
	}
}
