...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class wsSysMobileDepositosViewManager : BaseViewManager<wsSysMobileDepositos>
	{
		public wsSysMobileDepositosViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
