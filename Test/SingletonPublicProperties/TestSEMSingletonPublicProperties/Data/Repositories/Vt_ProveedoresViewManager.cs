...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class Vt_ProveedoresViewManager : BaseViewManager<Vt_Proveedores>
	{
		public Vt_ProveedoresViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
