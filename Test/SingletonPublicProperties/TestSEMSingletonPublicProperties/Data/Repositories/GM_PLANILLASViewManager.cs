...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class GM_PLANILLASViewManager : BaseViewManager<GM_PLANILLAS>
	{
		public GM_PLANILLASViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
