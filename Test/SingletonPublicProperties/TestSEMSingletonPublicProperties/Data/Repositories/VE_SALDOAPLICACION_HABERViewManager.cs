...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class VE_SALDOAPLICACION_HABERViewManager : BaseViewManager<VE_SALDOAPLICACION_HABER>
	{
		public VE_SALDOAPLICACION_HABERViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
