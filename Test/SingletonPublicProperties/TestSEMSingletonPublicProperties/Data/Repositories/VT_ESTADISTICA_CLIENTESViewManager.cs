...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class VT_ESTADISTICA_CLIENTESViewManager : BaseViewManager<VT_ESTADISTICA_CLIENTES>
	{
		public VT_ESTADISTICA_CLIENTESViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
