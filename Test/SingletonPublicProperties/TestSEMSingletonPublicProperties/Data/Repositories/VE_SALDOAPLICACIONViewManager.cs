...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class VE_SALDOAPLICACIONViewManager : BaseViewManager<VE_SALDOAPLICACION>
	{
		public VE_SALDOAPLICACIONViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
