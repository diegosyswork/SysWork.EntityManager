...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class VT_ESTADISTICA_CLIENTES_COBRANZASViewManager : BaseViewManager<VT_ESTADISTICA_CLIENTES_COBRANZAS>
	{
		public VT_ESTADISTICA_CLIENTES_COBRANZASViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
