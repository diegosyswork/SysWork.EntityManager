...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class VT_MV_CUOTAS_IMPAGASViewManager : BaseViewManager<VT_MV_CUOTAS_IMPAGAS>
	{
		public VT_MV_CUOTAS_IMPAGASViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
