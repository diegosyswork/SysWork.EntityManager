...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class V_AsientosCCostoViewManager : BaseViewManager<V_AsientosCCosto>
	{
		public V_AsientosCCostoViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
