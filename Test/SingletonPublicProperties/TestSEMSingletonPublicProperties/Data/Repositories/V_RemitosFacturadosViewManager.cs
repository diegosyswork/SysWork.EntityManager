...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class V_RemitosFacturadosViewManager : BaseViewManager<V_RemitosFacturados>
	{
		public V_RemitosFacturadosViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
