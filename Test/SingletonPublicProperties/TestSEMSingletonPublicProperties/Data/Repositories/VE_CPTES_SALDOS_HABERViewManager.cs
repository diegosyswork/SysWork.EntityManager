...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class VE_CPTES_SALDOS_HABERViewManager : BaseViewManager<VE_CPTES_SALDOS_HABER>
	{
		public VE_CPTES_SALDOS_HABERViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
