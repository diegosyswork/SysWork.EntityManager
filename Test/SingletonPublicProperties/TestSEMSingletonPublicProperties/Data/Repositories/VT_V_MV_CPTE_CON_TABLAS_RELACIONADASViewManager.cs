...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class VT_V_MV_CPTE_CON_TABLAS_RELACIONADASViewManager : BaseViewManager<VT_V_MV_CPTE_CON_TABLAS_RELACIONADAS>
	{
		public VT_V_MV_CPTE_CON_TABLAS_RELACIONADASViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
