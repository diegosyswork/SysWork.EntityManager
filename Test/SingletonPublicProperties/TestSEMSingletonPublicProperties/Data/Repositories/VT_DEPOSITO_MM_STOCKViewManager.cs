...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class VT_DEPOSITO_MM_STOCKViewManager : BaseViewManager<VT_DEPOSITO_MM_STOCK>
	{
		public VT_DEPOSITO_MM_STOCKViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
