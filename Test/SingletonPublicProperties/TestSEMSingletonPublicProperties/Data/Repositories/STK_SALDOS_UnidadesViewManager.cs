...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class STK_SALDOS_UnidadesViewManager : BaseViewManager<STK_SALDOS_Unidades>
	{
		public STK_SALDOS_UnidadesViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
