...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class P_EntrevistasFHViewManager : BaseViewManager<P_EntrevistasFH>
	{
		public P_EntrevistasFHViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
