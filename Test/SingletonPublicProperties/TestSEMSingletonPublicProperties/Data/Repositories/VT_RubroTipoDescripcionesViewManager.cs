...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class VT_RubroTipoDescripcionesViewManager : BaseViewManager<VT_RubroTipoDescripciones>
	{
		public VT_RubroTipoDescripcionesViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
