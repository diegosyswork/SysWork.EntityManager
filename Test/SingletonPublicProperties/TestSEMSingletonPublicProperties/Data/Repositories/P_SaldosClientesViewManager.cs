...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class P_SaldosClientesViewManager : BaseViewManager<P_SaldosClientes>
	{
		public P_SaldosClientesViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
