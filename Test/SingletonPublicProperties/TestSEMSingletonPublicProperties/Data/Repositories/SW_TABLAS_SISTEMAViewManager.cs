...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class SW_TABLAS_SISTEMAViewManager : BaseViewManager<SW_TABLAS_SISTEMA>
	{
		public SW_TABLAS_SISTEMAViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
