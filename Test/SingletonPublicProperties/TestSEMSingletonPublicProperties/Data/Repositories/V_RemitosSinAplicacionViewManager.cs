...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class V_RemitosSinAplicacionViewManager : BaseViewManager<V_RemitosSinAplicacion>
	{
		public V_RemitosSinAplicacionViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
