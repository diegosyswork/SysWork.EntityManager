...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class VT_CPTE_DiferidoViewManager : BaseViewManager<VT_CPTE_Diferido>
	{
		public VT_CPTE_DiferidoViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
