...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class CO_OCompraPendientesViewManager : BaseViewManager<CO_OCompraPendientes>
	{
		public CO_OCompraPendientesViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
