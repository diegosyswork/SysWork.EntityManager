...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class P_SolucitudesViewManager : BaseViewManager<P_Solucitudes>
	{
		public P_SolucitudesViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
