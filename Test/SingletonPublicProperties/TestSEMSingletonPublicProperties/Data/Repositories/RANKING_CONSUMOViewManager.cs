...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class RANKING_CONSUMOViewManager : BaseViewManager<RANKING_CONSUMO>
	{
		public RANKING_CONSUMOViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
