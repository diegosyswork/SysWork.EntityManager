...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class VE_CPTES_SALDOSViewManager : BaseViewManager<VE_CPTES_SALDOS>
	{
		public VE_CPTES_SALDOSViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
