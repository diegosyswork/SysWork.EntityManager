...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class CO_FCCore_PendientesViewManager : BaseViewManager<CO_FCCore_Pendientes>
	{
		public CO_FCCore_PendientesViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
