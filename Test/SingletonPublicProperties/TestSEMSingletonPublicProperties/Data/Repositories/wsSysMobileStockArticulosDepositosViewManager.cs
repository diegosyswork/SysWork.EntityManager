...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class wsSysMobileStockArticulosDepositosViewManager : BaseViewManager<wsSysMobileStockArticulosDepositos>
	{
		public wsSysMobileStockArticulosDepositosViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
