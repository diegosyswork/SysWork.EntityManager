...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class P_TodasLasSolicitudesPostViewManager : BaseViewManager<P_TodasLasSolicitudesPost>
	{
		public P_TodasLasSolicitudesPostViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
