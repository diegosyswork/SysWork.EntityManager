...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class V_RemitosConCobranzasViewManager : BaseViewManager<V_RemitosConCobranzas>
	{
		public V_RemitosConCobranzasViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
