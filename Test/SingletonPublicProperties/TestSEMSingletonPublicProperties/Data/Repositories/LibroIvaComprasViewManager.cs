...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class LibroIvaComprasViewManager : BaseViewManager<LibroIvaCompras>
	{
		public LibroIvaComprasViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
