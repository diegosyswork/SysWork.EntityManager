...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class V_ChequesEntregadosViewManager : BaseViewManager<V_ChequesEntregados>
	{
		public V_ChequesEntregadosViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
