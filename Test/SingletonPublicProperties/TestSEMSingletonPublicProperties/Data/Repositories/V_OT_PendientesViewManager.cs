...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class V_OT_PendientesViewManager : BaseViewManager<V_OT_Pendientes>
	{
		public V_OT_PendientesViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
