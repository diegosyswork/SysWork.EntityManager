...
namespace SysWork.SWCG.Test.ViewManagers
{
	...
	public partial class P_TodasLasSolicitudesPostulantesViewManager : BaseViewManager<P_TodasLasSolicitudesPostulantes>
	{
		public P_TodasLasSolicitudesPostulantesViewManager (string connectionString, EDatabaseEngine databaseEngine) : base(connectionString,databaseEngine)
		{
