...
{
	[Table (Name = "V_MV_Stock")]
	public partial class V_MV_Stock
	{
		/// <summary>
		...
		[Column()]
		public decimal? COSTOUDEQUIV { get; set; }
		[Column()]
		public decimal? IMPORTE_DTO { get; set; }
		[Column()]
		public decimal? IMPORTE_DTO_S_IVA { get; set; }
		[Column()]
		...
		[Column()]
		public decimal? COSTO_MONEDA1 { get; set; }
	}
}
